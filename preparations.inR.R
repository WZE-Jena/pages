...
path <- "D:/Documents/Uni_sync/11_Projekte/03_WZE@Jena/01_Allgemeine Infos über WZE-Punkte/02_GIS-Projekte/"
jena.forest.area <- geojson_sf("./Waldbiotope_th/WALDBIOTOPE.shp") %>%
  st_transform(, crs = 4326) %>% 
